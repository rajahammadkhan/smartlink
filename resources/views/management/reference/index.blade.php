...
@section('title')
References- {{ config('app.dashboard') }}
@endsection
@section('content')
    ...
    <div class="row clearfix">
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            ...
            <div class="card">
                <div class="header">
                    <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6">
                        <a href="{{ route('reference.create') }}" type="button" class="btn btn-primary"> Add
                            Reference
                        </a>
                    </div>
                        ...
                        <table class="table" id="myTable">
                            <thead>
                                <tr>
                                    ...
                                    <th class="col-lg-2">Legal Type</th>
                                    <th class="col-lg-2">User Account</th>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td>
                                        <a class="text-blue" href="{{ route('reference.show', $row->id) }}">{{ $row->unique_number ?? '' }}</a>
                                    </td>
                                    <td>
                                        {{ $row->account_name ?? '' }}
                                    </td>
                                    ...
                                    <td>
                                        <a class="btn bg-blue btn-circle" href="{{ route('reference.edit', $row->id) }}">
                                            ...
                                            <div class="modal-dialog modal-dialog-centered" role="document">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-footer">
                                                        ...
                                                        <form action="{{ route('reference.destroy', $row->id) }}" method="post">
                                                            @csrf
                                                            @method('DELETE')
