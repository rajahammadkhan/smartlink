...
@section('title')
Customers- {{ config('app.dashboard') }}
@endsection
@section('content')
    ...
    <div class="row clearfix">
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            ...
            <div class="card">
                <div class="header">
                    <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6">
                        <a href="{{ route('customer.create') }}" type="button" class="btn btn-primary"> Add
                            Customer
                        </a>
                    </div>
                        ...
                        <table class="table" id="myTable">
                            <thead>
                                <tr>
                                    ...
                                    <th class="col-lg-2">NTN Number</th>
                                    <th class="col-lg-2">STRN Number</th>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td>
                                        <a class="text-blue" href="{{ route('customer.show', $row->id) }}">{{ $row->unique_number ?? '' }}</a>
                                    </td>
                                    <td>
                                        {{ $row->name ?? '' }}
                                    </td>
                                    ...
                                    <td>
                                        <a class="btn bg-blue btn-circle" href="{{ route('customer.edit', $row->id) }}">
